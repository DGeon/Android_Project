...
public class PayCheckOriginal extends AppCompatActivity {
    ...
    public void onClick(View view){
        switch (view.getId()){
            ...
            case  R.id.payBtnSerch:
                ...
                int total = Integer.parseInt(basic) +overpay;
                payTemp = total - Integer.parseInt(meal);
                ...
                //근로소득세(간이세액-지방소득세10%)
                int tex = Math.abs((payTemp/12)/1000);
                ...
                //년 예상 실수령
                tpay = (total/12)-np-hi-ni-ei-eit-lit;
                ypay = tpay*12;
